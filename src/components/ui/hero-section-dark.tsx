      ...
      <div className={cn("relative", className)} ref={ref} {...props}>
        ...
        <section className="relative max-w-full mx-auto z-1">
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-28 gap-12 md:px-8">
              ...
              <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
                ...
                {secondaryCtaText && onSecondaryCtaClick && (
                  <button
                    ...
                    className="inline-flex rounded-full text-center items-center justify-center bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all py-4 px-10"
                  >
                    {secondaryCtaText}
                  </button>
                )}
            ...
            {bottomImage && (
              <div className="mt-32 mx-auto max-w-4xl px-4 relative z-10">
                <img
